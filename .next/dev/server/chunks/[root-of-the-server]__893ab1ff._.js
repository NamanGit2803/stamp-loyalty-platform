...
async function POST(req) {
    try {
        ...
        const existingShop = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].shop.findFirst({
            where: {
                ownerId
            }
        });
        ...
        // Create new shop
        const newShop = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].shop.create({
            data: {
                id: customId,
                ownerId,
                shopName,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__893ab1ff._.js.map