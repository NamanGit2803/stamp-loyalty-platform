...
async function POST(req) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].subscription.findFirst({
            where: {
                shopId
            }
        });
        ...
        const subscription = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].subscription.create({
            data: {
                id: customId,
                shopId,
                amount: 299,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14ba956f._.js.map