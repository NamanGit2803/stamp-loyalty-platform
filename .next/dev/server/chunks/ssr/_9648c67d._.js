    ...
    const verifyScreenshot = async (file, phone, ocrResult, screenshotHash)=>{
        ...
        try {
            ...
            if (data.success) {
                ...
                setResult({
                    error: data.error || data.rejectReason || "Verification failed"
                });
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.error || data.rejectReason || "Verification failed");
            }
...
//# sourceMappingURL=_9648c67d._.js.map