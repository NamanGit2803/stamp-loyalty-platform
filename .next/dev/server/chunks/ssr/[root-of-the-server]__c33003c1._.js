...
const Step2 = ({ setStep })=>{
    ...
    const submit = async (e)=>{
        ...
        if (shopStore.error) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$email$2f$sendWelcomeEmail$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendWelcomeEmail"])({
                to: userStore.user.email,
                name: user.name,
                shopName: shop.name,
                trialEndDate: "Feb 10, 2026",
                dashboardUrl: `${("TURBOPACK compile-time value", "https://stampi.in")}/dashboard`
            });
            return;
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c33003c1._.js.map