...
const ChangePasswordDialog = ()=>{
    ...
    const handleChangePassword = async ()=>{
        if (passwordData.current == '' || passwordData.new == '' || passwordData.confirm == '') {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Please fill in all password fields.");
            return;
        }
        if (passwordData.new != passwordData.confirm) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("New and confirm passwords do not match.");
            return;
        }
        await userStore.updateProfile({
...
//# sourceMappingURL=_c59169be._.js.map