...
"[project]/components/claimPage/invalidQRUI.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InvalidQRUI() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
            className: "w-full max-w-md border-red-200 shadow-md rounded-2xl",
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$triangle$2d$alert$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertTriangle$3e$__["AlertTriangle"], {
                            ...
                            fileName: "[project]/components/claimPage/invalidQRUI.jsx",
                            lineNumber: 11,
                            columnNumber: 13
                        }, this)
                    }, void 0, false, {
...
"[project]/lib/aiParser.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openai$2f$client$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__OpenAI__as__default$3e$__["default"]({
    apiKey: process.env.DEEPSEEK_API_KEY,
    baseURL: "https://api.deepseek.com/v1"
});
/**
 * Decide whether AI is needed (COST CONTROL)
 */ function shouldCallAI(text) {
    if (!text) return false;
    if (text.length < 30) return false;
    if (!/₹|\bRs\b|\bINR\b/i.test(text)) return false;
    return true;
}
/**
 ...
 */ function parseLLMJson(raw) {
    ...
    text = text.replace(/,\s*}/g, "}").replace(/,\s*]/g, "]").replace(/\n/g, " ").replace(/\t/g, " ");
    return JSON.parse(text);
}
async function parsePaymentOCR(ocrText) {
    // 🛑 COST CONTROL: Skip AI if clearly useless
    if (!shouldCallAI(ocrText)) {
        return {
            amount: null,
            upiId: null,
            utr: null,
    ...
    try {
        const prompt = `
Extract payment info from text.
Return ONLY raw JSON.

Rules:
- amount must be number or null
- upiId must contain "@"
- utr must be alphanumeric (8–25 chars) or null
- app must be one of: GPay, PhonePe, Paytm, AmazonPay, UNKNOWN
- fake = true if text looks edited, partial, or unclear
...
`;
        const res = await client.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a strict JSON generator. Output ONLY valid JSON. No markdown. No explanation."
                },
                {
                    role: "user",
                    content: prompt
        ...
        console.error("DeepSeek Parser ERROR →", err);
        // ❗ Safe fallback — never break API
        return {
            amount: null,
            upiId: null,
            utr: null,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aiParser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/aiParser.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
;
const ClaimCard = ({ verify, loading, setLoading })=>{
    ...
    // VERIFY (DeepSeek ONLY)
    const handleVerify = async (e)=>{
        e.preventDefault();
        if (!file || phone.length < 10) return;
        setLoading(true);
        const resized = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aiParser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resizeImage"])(file);
        // 🚀 Send ONLY image + phone to server
        await verify(resized, phone);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        onClick: !preview ? ()=>document.getElementById("file")?.click() : undefined,
                        className: "relative flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg w-full cursor-pointer bg-gray-50 hover:bg-gray-100 p-5 min-h-[170px]",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$claimPage$2f$invalidQRUI$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/claimPage/invalidQRUI.jsx [app-ssr] (ecmascript)");
...
const ClaimPage = ({ shopId })=>{
    ...
    if (!shopId) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$claimPage$2f$invalidQRUI$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkShop = async ()=>{
            try {
                ...
                console.error(error);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Invalid shop");
                setIsInvalid(true);
            }
        };
        checkShop();
    ...
    /* ------------------------------
     🔵 VERIFY SCREENSHOT
     (DeepSeek OCR on server)
  --------------------------------*/ const verifyScreenshot = async (file, phone)=>{
        if (!file) return;
        ...
        try {
            ...
            if (data.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Payment Verified! Stamp added 🎉");
            } else {
                const msg = data.error || data.rejectReason || "Verification failed";
                setResult({
                    error: msg
                });
...
//# sourceMappingURL=_a3da127a._.js.map