...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sendEmail$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/sendEmail.js [app-route] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '../templates/planExpiredEmail'");
...
async function GET() {
    try {
        ...
        // -----------------------------------------
        // ✅ FIX: Convert UTC → IST for correct logic
        // -----------------------------------------
        ...
        const startOfTomorrowIST = new Date(nowIST.getFullYear(), nowIST.getMonth(), nowIST.getDate() + 1);
        ...
        // -----------------------------------------
        // 🔍 Find subscriptions expiring TODAY (IST)
        // -----------------------------------------
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97955834._.js.map