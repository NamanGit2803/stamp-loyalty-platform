...
"use client";
const generateStyledQR = async (qr)=>{
    ...
    ctx.stroke();
    // Draw QR
    ctx.drawImage(basicQR, padding + 40, padding + 40, boxSize - 80, boxSize - 80);
    // Footer text
...
const ScannerComponent = _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mobx$2d$react$2d$lite$2f$es$2f$observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["observer"])(_c = _s(()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ScannerComponent.useEffect": ()=>{
            ...
            const url = `${("TURBOPACK compile-time value", "http://localhost:3000")}/claim?shopId=${shopId}`;
    ...
    const handleDownload = async ()=>{
        if (!qr) return;
        const styledQR = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generateStyledQR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateStyledQR"])(qr);
