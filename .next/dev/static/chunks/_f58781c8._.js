...
"[project]/lib/generateStyledQR.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
const generateStyledQR = async (qrBase64, shopName)=>{
    ...
    /* ------------------ 1. Load Canva Template ------------------ */ const template = new Image();
    template.src = "/qr-template.png";
    await new Promise((res)=>template.onload = res);
    ctx.drawImage(template, 0, 0, width, height);
    /* ------------------ 2. Draw Shop Name ------------------ */ ctx.font = "600 70px 'Nunito', sans-serif";
    ctx.fillStyle = "#404040";
    ctx.textAlign = "center";
    // Perfect position for shop name
    ctx.fillText(shopName, width / 2, 860);
    /* ------------------ 3. Load QR Code ------------------ */ const qr = new Image();
    qr.src = qrBase64;
    await new Promise((res)=>qr.onload = res);
    /* ------------------ 4. Draw QR Code ------------------ */ const qrX = 515;
    const qrY = 985;
    const qrSize = 510;
    ctx.drawImage(qr, qrX, qrY, qrSize, qrSize);
    /* ------------------ 5. Return Output ------------------ */ return canvas.toDataURL("image/png");
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/shop/Scanner-page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generateStyledQR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/generateStyledQR.js [app-client] (ecmascript)");
...
;
;
const ScannerComponent = _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mobx$2d$react$2d$lite$2f$es$2f$observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["observer"])(_c = _s(()=>{
    _s();
    ...
    const [qr, setQr] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ScannerComponent.useEffect": ()=>{
            if (!shopId) return;
            setLoading(true); // ← start loading
            const url = `${("TURBOPACK compile-time value", "https://stampi.in")}/claim?shopId=${shopId}`;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].toDataURL(url, {
                width: 800,
                margin: 1
            }).then({
                "ScannerComponent.useEffect": (data)=>{
                    setQr(data);
                    setLoading(false); // ← QR generated
                }
            }["ScannerComponent.useEffect"]).catch({
                "ScannerComponent.useEffect": ()=>setLoading(false)
            }["ScannerComponent.useEffect"]);
        }
    }["ScannerComponent.useEffect"], [
        shopId
    ...
    const handleDownload = async ()=>{
        if (!qr) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("QR not found.");
            return;
        }
        ;
        const styledQR = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generateStyledQR$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateStyledQR"])(qr, shopStore.shop?.shopName);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "w-full max-w-sm shadow-xl border-0 rounded-2xl backdrop-blur ",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                        ...
                        children: "Shop QR Code"
                    }, void 0, false, {
                        fileName: "[project]/components/shop/Scanner-page.jsx",
                        lineNumber: 68,
                        columnNumber: 17
                    }, ("TURBOPACK compile-time value", void 0)),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-sm text-muted-foreground mt-1",
                        children: "Display this QR at your counter for customers to scan."
                    }, void 0, false, {
                        fileName: "[project]/components/shop/Scanner-page.jsx",
                        lineNumber: 71,
                        columnNumber: 17
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: [
                    ...
                    !loading && qr && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-4 rounded-xl bg-white border shadow-inner fade-in",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: loading ? "Please wait..." : "Download QR"
                            }, void 0, false, {
                                fileName: "[project]/components/shop/Scanner-page.jsx",
                                lineNumber: 99,
                                columnNumber: 21
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                variant: "secondary",
                                className: "w-full text-base py-2 font-medium hover:cursor-pointer",
                                children: loading ? "Please wait..." : "Print QR"
                            }, void 0, false, {
                                fileName: "[project]/components/shop/Scanner-page.jsx",
                                lineNumber: 107,
                                columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Customers can scan this to access your loyalty page and claim rewards by uploading payment screenshots."
                    }, void 0, false, {
                        fileName: "[project]/components/shop/Scanner-page.jsx",
                        lineNumber: 117,
                        columnNumber: 17
...
}, "oPNYUHGdikg2C8y+krwxfk5KfSQ=", false, function() {
    return [
...
_c1 = ScannerComponent;
const __TURBOPACK__default__export__ = ScannerComponent;
var _c, _c1;
__turbopack_context__.k.register(_c, "ScannerComponent$observer");
__turbopack_context__.k.register(_c1, "ScannerComponent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f58781c8._.js.map