...
const ClaimCard = ({ shopId, verify, loading, setLoading })=>{
    ...
    --------------------------------*/ const handleVerify = async (e)=>{
        ...
        const ocrResult = {
            ...
            utr: extractUTR(text),
            date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractDate"])(text)
        };
    ...
    const verifyScreenshot = async (file, phone, ocrResult, screenshotHash)=>{
        ...
        try {
            ...
            if (data.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.error || data.rejectReason || "Verification failed");
            }
...
//# sourceMappingURL=_b0d54368._.js.map