...
function PlanPage() {
    ...
    return(// <div className="min-h-screen w-full flex flex-col items-center px-6 py-10 bg-custom-gradient">
    //   {/* Heading */}
    //   <h1 className="text-3xl font-bold text-secondary">Subscription Plan</h1>
    //   <p className="text-gray-600 mt-2 text-center max-w-md">
    //     Unlock everything with a 15-day free trial.
    //   </p>
    //   {/* Compact Card */}
    //   <Card
    //     className="
    ...
    //         <CardTitle className="text-xl font-semibold">Pro Plan</CardTitle>
...
//# sourceMappingURL=_034754ec._.js.map