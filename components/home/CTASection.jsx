...
const CTASection = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 md:px-8 py-15">
            <Card className="bg-linear-to-r from-primary to-[#815AC0] p-12 text-center border-0">
                ...
                <Button asChild size="lg" className="h-12 bg-white text-primary hover:bg-light-shade">
